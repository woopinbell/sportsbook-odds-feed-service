 ...
 * and market keys (24h per the project cache contract). Split into per-key TTLs when the
 * operational cost of cache misses on long-lived metadata starts to matter.
 */
